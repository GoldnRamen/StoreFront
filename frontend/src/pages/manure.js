            ...
            <>
                <div className="relative flex flex-col">
                    ...
                    <div className="ml-[5%] mt-32 p-4 space-y-10 flex flex-col relative">
                        ...
                        <ul className="grid lg:grid-cols-3 space-y-10 space-x-5 text-center h-fit">
