...
export default function Home(){
    ...
    return(
        ...
        <div className="relative lg:ml-[5%]">
            <div className={`${overlay ? "opacity-70 h-[95vh] w-full fixed top-[400px] lg:top-[59px] bg-black z-40" : null} `}></div>
            <img alt={"IMAGES"} src={"https://ideogram.ai/assets/image/lossless/response/pHogom8BRzmrgOVOX4FLXw"}
            ...
            <div className="p-2 mt-[20vh] mx-auto">
                    ...
                    <div className="text-sm lg:text-lg">
                        ...
                        <ul className="space-y-4 my-10">
                            <li className="grid grid-cols-3 gap-2 items-center mt-[5vh]">
                                ...
                                <img alt={"IMAGES"} src={"https://ideogram.ai/assets/progressive-image/balanced/response/yX8-4GMjTLKVMKcR7HND4g"} className="w-full object-cover h-full"/>
                            </li>
                            <li className="grid grid-cols-3 gap-2 items-center">
                                <img alt={"IMAGES"} src={"https://ideogram.ai/assets/progressive-image/balanced/response/iQD_BMtyTlamrKsvkkqq4w"} className="w-full object-cover h-full"/>
                                <div className="col-span-2">
                            ...
                            <li className="grid grid-cols-3 gap-2 items-center">
                                ...
                                <img alt={"IMAGES"} src={"https://cdn.pixabay.com/photo/2017/08/04/18/04/egg-2580904_1280.jpg"} className="w-full object-cover h-full"/>
                            </li>
                            <li className="grid grid-cols-3 gap-2 items-center">
                                <img alt={"IMAGES"} src={"https://www.poultryworld.net/app/uploads/2021/04/001_302_IMG_feathers-768x512.jpg"} className="w-full object-cover h-full"/>
                                <div  className="col-span-2">
                                    <p>Feathers</p>
                ...
                <div className="my-[5vh] relative">
                    <div className="grid grid-cols-2 gap-4">
                        <img alt={"IMAGES"} src="https://ideogram.ai/assets/progressive-image/balanced/response/haIL6hEpTPyI3dK5eoD-2A" className="w-full h-[30vh] lg:h-[70vh] object-cover object-center"/>
                        <img alt={"IMAGES"} src="https://ideogram.ai/assets/progressive-image/balanced/response/P6KB-uHMT0yewoeHyTFvAg" className="w-full h-[30vh] lg:h-[70vh] object-cover object-center"/>
                    </div>
                ...
                <div className="w-[80%] mx-auto lg:grid grid-cols-5 gap-3 my-[15vh] border-t border-b py-3 hidden">
                    <img alt={"IMAGES"} src="/dung.png" className="w-full h-[20vh] object-contain object-center"/>                    
                    ...
                    <img alt={"IMAGES"} src="/compost.png" className="w-full h-[20vh] object-contain object-center"/>
                </div>
