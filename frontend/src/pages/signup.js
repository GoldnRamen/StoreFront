...
export default function Signup(){
    ...
    const handleCreate = async(e)=>{
        ...
        try {
            const response = await axios.post("http://localhost:5000/api/users/register", inputValues)
    ...
    return(
        ...
        <div className="relative w-full h-[100vh] flex flex-col">
            <Navbar />
            <img src="https://ideogram.ai/assets/progressive-image/balanced/response/haIL6hEpTPyI3dK5eoD-2A" className="absolute w-full object-cover h-full object-center opacity-40"></img>
